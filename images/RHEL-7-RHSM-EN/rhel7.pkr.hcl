...
variable "RHEL_7_vm-name" {
    type        = string
    description = "RedHat VM Name"
    sensitive   = true
}

variable "RHEL_7_iso-path" {
    type        = string
    description = "RHEL 7 ISO Path"
    sensitive   = true
}
