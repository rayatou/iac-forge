...
variable "RHEL_9_vm-name" {
    type        = string
    description = "RedHat VM Name"
    sensitive   = true
}

variable "RHEL_9_iso-path" {
    type        = string
    description = "RHEL 9 ISO Path"
    sensitive   = true
}
...
source "vsphere-iso" "rhel9" {
    ...
    vm_name                     = var.RHEL_9_vm-name
    notes                       = "VER: ${ local.build_version }\nDATE: ${ local.build_date }\nOS: RedHat Enterprise Linux 9 Server"
